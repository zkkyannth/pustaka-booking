		...
		<table>
			...
			<tr>
				<td>
					...
					<a class="btn btn-sm btn-outline-secondary" onclick="information('Waktu Pengambilan Buku 1x24 jam dari Booking!!!')" href="<?php echo base_url() . 'booking/exportToPrint/' . $this->session->userdata('id_user');?>"><span class="fas fa-lg fa-fw fa-print"></span> Print</a>
				</td>
			</tr>
		</table>
	</center>
